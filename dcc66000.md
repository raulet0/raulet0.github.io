---
layout: single
title: Décodeur DCC NMRA dans une 66000 JOUEF de 1996
permalink: /dcc66000/
---

Je vous propose ici le montage d'un décodeur quelconque (conforme à la norme [NMRA](http://www.nmra.org)) dans une 66000 JOUEF de 1996. La procédure décrite ci-dessous a été réalisée sur ma 66487 en 1997. Aujourd'hui, en 2025, je peux témoigner que tout a bien fonctionné sans aucun problème depuis cette installation. 

Le montage dans cette 66000 JOUEF de 1996 est plus délicat que le [montage dans une 67000 LIMA de 1995](/dcc67000) car la place disponible est beaucoup plus réduite et le circuit imprimé principal doit être remplacé, mais bonne nouvelle : il est possible de conserver la cabine intacte de manière à pouvoir l'équiper d'un conducteur !  
...
![Schéma de cablage d'un décodeur NMRA dans une 66000 (14 Ko)](../images/dcc66000.gif)
...
Nous sommes plusieurs à avoir constaté parfois une vitesse irrégulière de la locomotive qui est difficile à expliquer, et qui se produit à une allure modérée. La première raison pourrait être l'échauffement du décodeur qui se trouve très mal aéré, ce qui entraine une variation des paramètres de fonctionnement. La seconde raison peut s'expliquer par une courbe de fonctionnement du moteur non linéaire en fonction de la tension d'alimentation (ce que j'avais déjà constaté sans décodeur, avec mon alimentation asservie Gaugemaster).
